...
class Storage(object):
    ...
    # convert between okcash addresses and 20 bytes keys used for storage. 
    ...
    def write_undo_info(self, height, okcashd_height, undo_info):
        if height > okcashd_height - 100 or self.test_reorgs:
